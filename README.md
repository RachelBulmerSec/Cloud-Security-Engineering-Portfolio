...
|---------|---------|-----------|
|**Audit_Azure_ServicePrincipal | Problem: Standard Azure audits don't show the effective permissions of a Service Principal, especially permissions inherited from being in a group. | Solution: This advanced script audits all Service Principals, finds their direct Azure RBAC 
_Permissions.ps1** | Problem: Standard Azure audits don't show the effective permissions of a Service Principal, especially permissions inherited from being in a group. | Solution: This advanced script audits all Service Principals, finds their direct Azure RBAC roles, and then recursively audits their group memberships to find all inherited permissions. This is critical for identifying over-privileged service accounts.|
